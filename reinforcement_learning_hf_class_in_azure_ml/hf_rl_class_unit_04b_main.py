...
aml_command_display_name = f"HF RL Course - Unit 04-B - Training Job {job_timestamp.strftime('%Y-%m-%d %H:%M:%S')}"
aml_experiment_name = 'hf_rl_class_unit_04b_experiment'
aml_model_name = "hf_rl_class_unit_04b_model" 

training_script_folder = "./scripts/"
training_script_name = "hf_rl_class_unit_04b_train.py"
